...
curl -O https://raw.githubusercontent.com/{{OWNER}}/claude-code-os/main/CLAUDE.md
curl -O https://raw.githubusercontent.com/{{OWNER}}/claude-code-os/main/WORKING.md
curl -O https://raw.githubusercontent.com/{{OWNER}}/claude-code-os/main/done.sh
chmod +x done.sh
```

> `{{OWNER}}` は公開後のリポジトリ owner（例: `your-handle`）に置換する。
> 公開リポジトリ: `https://github.com/{{OWNER}}/claude-code-os`
...
→ [BOOTH 販売ページ](https://your-booth-shop.booth.pm/) ※公開後に実 URL に置換
...
→ [Zenn の連載ページ](https://zenn.dev/{{OWNER}}) ※公開後に実 URL に置換
